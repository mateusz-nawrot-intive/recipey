...
@ActivityScope
class SplashScreenViewModelFactory @Inject constructor(private val navigationRouter: NavigationRouter) : ViewModelProvider.Factory{
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        ...
        return SplashScreenViewModel(navigationRouter) as T
    }
}